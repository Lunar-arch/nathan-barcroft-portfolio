...
const Header = ({
  ...
  return (
    <div
      tabIndex={-1}
      className="fixed top-0 inset-x-0 z-70 h-20 bg-linear-to-b from-background from-[1rem] to-transparent p-4 md:px-6 flex flex-row justify-center"
    >
      <motion.header
        id="site-header"
      ...
      >
        ...
        >
          <motion.div className="flex items-center" variants={itemVariants}>
            <Link
              href="/"
              aria-label="Nathan Barcroft - Home"
              className="font-semibold text-foreground focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-foreground"
            >
              Nathan Barcroft
            </Link>
          </motion.div>
          ...
          <motion.nav
            aria-label="Primary"
            className="hidden sm:flex h-full flex-row items-center gap-4 text-foreground"
            role="navigation"
